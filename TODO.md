...
4.  **Simple notes + mood/energy check-in**
...
6.  **Grocery / planning side panel (later)**
...
-   **Daily Targets + Progress Rings:** Implemented visual SVG rings for Calories, Protein, Carbs, and Fats with a dedicated adjustment modal and sync to Firestore/localStorage.
